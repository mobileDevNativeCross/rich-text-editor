    ...
    WebViewBridge.onMessage = function (message) {
      ...
      switch(action.type) {
        ...
        case '${actions.insertHTML}':
          zss_editor.insertHTML(action.data, html);
          break;
        case '${actions.setContentHTML}':
          zss_editor.setContentHTML(action.data, html);
          break;
        case '${actions.insertImageBase64String}':
          zss_editor.insertImageBase64String(action.data.imageBase64String, action.data.alt);
          break;
        case '${actions.focusEditor}':
          zss_editor.focusEditor(action.data);
          break;
        case '${actions.insertData}':
          zss_editor.insertData(action.data);
          break;        
      }
    };
  }
